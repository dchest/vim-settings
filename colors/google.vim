...
" changelog:
"         0.2:	2008.11.27
"         		changed MatchParen to link to Type (thanks to JarosÅ‚aw MÄ™Å¼yk)
"         		added Diff*
"         0.1:	2008.11.20
"       		initial version
...
hi ModeMsg		guifg=#111111 guibg=#ffffff gui=bold
...
hi Statement 	guifg=#2a5db0	guibg=#ffffff	gui=none
hi StatusLine 	guifg=#ffffff	guibg=#6694e3	gui=bold
hi StatusLineNC guifg=#aaaaaa	guibg=#e0ecff	gui=none
hi Todo 		guifg=#ffffff	guibg=#d96666	gui=none
hi Type 		guifg=#006633	guibg=#ffffff	gui=none
...
hi Paren                  guibg=#FFE88B gui=none
